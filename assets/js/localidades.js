...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"localidades.js":[function(require,module,exports) {
"use strict";
...
deleteBtns.forEach(function (item, index) {
  item.addEventListener('click', function _callee(e) {
    var localidadeId, row, localidade, result, response;
    return regeneratorRuntime.async(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            localidadeId = this.dataset.localidade;
            row = this.closest('tr');
            localidade = row.querySelector('.localidade').textContent;
            _context.next = 6;
...
},{"sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js","axios":"../../node_modules/axios/index.js"}]},{},["localidades.js"], null)