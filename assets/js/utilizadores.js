...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"utilizadores.js":[function(require,module,exports) {
"use strict";
...
deleteBtns.forEach(function (item, index) {
  item.addEventListener('click', function _callee(e) {
    var userId, row, username, result, response;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            row = this.closest('tr');
            username = row.querySelector('.utilizadores_username').textContent;
            _context.next = 6;
...
function closeAllUserLevelChangers(userLevelChange) {
  userLevelChange.forEach(function (el) {
    el.classList.remove('userLevelChange-open');
  });
} // LEVEL TOOGLE


var userLevel = document.querySelectorAll('.userLevel');
var userLevelChange = document.querySelectorAll('.userLevelChange');
userLevel.forEach(function (level, index) {
...
},{"sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js","axios":"../../node_modules/axios/index.js"}]},{},["utilizadores.js"], null)