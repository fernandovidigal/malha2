...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"configuracoes.js":[function(require,module,exports) {
"use strict";
...
serverPortBtn.addEventListener('click', function _callee(e) {
  var inputServerPort, inputServerPortValue, response;
  return regeneratorRuntime.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
          inputServerPort = document.getElementById('serverPort');
          inputServerPortValue = parseInt(inputServerPort.value.trim());
...
function showError(element, errorText) {
  ...
  var error = document.querySelector('.smallWarningText');
