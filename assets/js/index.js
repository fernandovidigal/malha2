...
var checkConnection = function checkConnection() {
  var connection, conectionStatus, connectionStatusText;
  return regeneratorRuntime.async(function checkConnection$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return regeneratorRuntime.awrap(_axios.default.get('/checkConnection'));
        ...
        case 2:
          ...
          conectionStatus = document.querySelector('.connectionStatus');
...
var sync = document.querySelector('.syncData');

if (sync) {
  (function _callee() {
    var connectionAlive, syncResponse;
    return regeneratorRuntime.async(function _callee$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return regeneratorRuntime.awrap(checkConnection());

          case 2:
            connectionAlive = _context2.sent;
            ...
            _context2.next = 7;
            return regeneratorRuntime.awrap(_axios.default.get('/syncData'));

          case 7:
            syncResponse = _context2.sent;
...
},{"sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js","axios":"../../node_modules/axios/index.js"}]},{},["index.js"], null)