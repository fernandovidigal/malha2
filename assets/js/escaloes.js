...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"escaloes.js":[function(require,module,exports) {
"use strict";
...
deleteBtns.forEach(function (item, index) {
  item.addEventListener('click', function _callee(e) {
    var escalaoId, row, designacao, sexo, result, response;
    return regeneratorRuntime.async(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            escalaoId = this.dataset.escalao;
            row = this.closest('tr');
            designacao = row.querySelector('.escalao').textContent;
...
},{"sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js","axios":"../../node_modules/axios/index.js"}]},{},["escaloes.js"], null)