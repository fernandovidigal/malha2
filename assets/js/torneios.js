...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"torneios.js":[function(require,module,exports) {
"use strict";
...
deleteBtns.forEach(function (item, index) {
  item.addEventListener('click', function _callee(e) {
    var torneioId, row, designacao, localidade, result, response;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            row = this.closest('tr');
            designacao = row.querySelector('.torneio_designacao').textContent;
            localidade = row.querySelector('.torneio_localidade').textContent;
            _context.next = 7;
...
var resetButtons = document.querySelectorAll('.btn-faseReset');
resetButtons.forEach(function (btn) {
  btn.addEventListener('click', function _callee2(e) {
    var escalaoId, fase, designacao, torneioId, result, response;
    return regeneratorRuntime.async(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            escalaoId = parseInt(this.dataset.escalao);
            fase = parseInt(this.dataset.fase);
          ...
          case 12:
            ...
            _sweetalert.default.fire({
              icon: 'success',
              html: "<strong>Fase ".concat(response.data.fase != 100 ? response.data.fase : 'Final', "</strong> do escal\xE3o <strong>").concat(designacao, "</strong> eliminada com sucesso!"),
              showConfirmButton: false,
              timer: 1500,
              onClose: function onClose() {
                var url = "".concat(window.location.protocol, "//").concat(window.location.hostname, ":").concat(window.location.port, "/admin/torneios/editarTorneio/").concat(torneioId, "/3");
